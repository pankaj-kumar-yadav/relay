...
const DOCUMENTED_PATHS = [
  ...
  '/orgs/{orgId}/issues/{issueId}/subscription',
  '/orgs/{orgId}/issues/{issueId}/attachments',
  '/orgs/{orgId}/issues/{issueId}/attachments/intent',
  '/orgs/{orgId}/issues/{issueId}/attachments/{attachmentId}',
  '/orgs/{orgId}/issues/{issueId}/attachments/{attachmentId}/complete',
