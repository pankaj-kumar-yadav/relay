...
**Spec:** [docs/superpowers/v1/August-2026/specs/2026-08-27-issue-comments-activity-design.md](../specs/2026-08-27-issue-comments-activity-design.md)
...
**Files:**
- Modify: `docs/steps/v1/10-comments-activity.md` — Status Done, check Done when
...
- Modify: `docs/steps/mvp/00-overview.md` — next is step 11 only after 10 is actually done
