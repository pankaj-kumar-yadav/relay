...
Each step gets a thin file under `docs/steps/v1/`. Implementation still needs a per-slice spec/plan before code (same as KeyStore / orgs).
...
- Thin `docs/steps/v1/10-*.md` … `17-*.md`
