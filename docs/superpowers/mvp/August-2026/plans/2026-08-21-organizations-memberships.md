...
**Spec:** [docs/superpowers/mvp/August-2026/specs/2026-08-21-organizations-memberships-design.md](../specs/2026-08-21-organizations-memberships-design.md)
...
| `docs/steps/mvp/05-multi-tenant.md` | Mark progress; note invites deferred |
...
**Files:**
- Modify: `docs/steps/mvp/05-multi-tenant.md`
...
In `docs/steps/mvp/05-multi-tenant.md`:
...
```bash
git add docs/steps/mvp/05-multi-tenant.md docs/STEPS.md docs/ARCHITECTURE.md docs/README.md
git commit -m "$(cat <<'EOF'
