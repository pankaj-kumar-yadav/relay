...
**Spec:** [docs/superpowers/mvp/August-2026/specs/2026-08-21-api-response-envelope-design.md](../specs/2026-08-21-api-response-envelope-design.md)
...
| `docs/steps/mvp/04-auth.md` | Update convention |
| `docs/steps/mvp/09-hardening.md` | Update error section |
...
- Modify: `docs/steps/mvp/04-auth.md`
- Modify: `docs/steps/mvp/09-hardening.md`
...
In `docs/steps/mvp/04-auth.md`, replace the bullet:
...
In `docs/steps/mvp/09-hardening.md`, replace the “Standardize API errors” JSON example with:
