...
**Spec:** [docs/superpowers/mvp/August-2026/specs/2026-08-21-jwt-auth-postgres-design.md](../specs/2026-08-21-jwt-auth-postgres-design.md)
...
- Modify: `docs/steps/mvp/03-database.md` (status / ORM)
- Modify: `docs/steps/mvp/04-auth.md` (status / JWT cookie choice)
