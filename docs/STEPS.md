...
Detail for each step: [`docs/steps/mvp/`](./steps/mvp/) (MVP), [`docs/steps/v1/`](./steps/v1/) (v1), [`docs/steps/v2/`](./steps/v2/) (v2).
...
1. Stay inside the **current** scope file ([SCOPE-V2.md](./SCOPE-V2.md) — no billing, SSO, AI, or realtime)
...
5. Each v2 slice needs its own spec/plan before code. Thin step files are the roadmap, not the playbook.

## Suggested order of reading for a new agent

1. [SCOPE.md](./SCOPE.md) then the **current** release scope ([SCOPE-V2.md](./SCOPE-V2.md))
2. [ARCHITECTURE.md](./ARCHITECTURE.md)
3. This file, then [STEPS-V2.md](./STEPS-V2.md)
4. The **current** step file under `steps/v2/` (do not implement future steps early)
5. That step’s design spec under [superpowers/v2/](./superpowers/v2/) (`Month-Year/specs/`) when one exists
