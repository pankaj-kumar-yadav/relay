...
Team daily on shipped v1 ([STEPS-V1.md](./STEPS-V1.md)).
...
1. Stay inside [SCOPE-V2.md](./SCOPE-V2.md) — no billing, SSO, AI, or realtime.
2. Do not start a later slice before the current step’s “Done when”.
3. Each slice needs its own spec/plan before code (same as v1). Thin step files are the roadmap, not the playbook.
