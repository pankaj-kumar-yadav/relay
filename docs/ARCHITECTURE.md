...
Follow [STEPS.md](./STEPS.md) ([MVP](./STEPS-MVP.md) done, [v1](./STEPS-V1.md) current). Detail in [steps/](./steps/). Current step: [12-inbox.md](./steps/12-inbox.md). Do not skip auth/tenancy before wiring real issue data into the UI.
